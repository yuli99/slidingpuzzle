...
<div class="jumbotron">
    <img src="<c:url value="/resources/images/logo.png" />" class="img-fluid" alt="Responsive image" height="150">
    <br /><br />
...
<div class="row featurette">
	<div class="col-md-7">
		<div class="col-lg-4">
			<h4>Level: easy</h4>
			<img src="<c:url value="/resources/images/8-puzzle.png" />" alt="Responsive image" height="110">
		...
		<div class="col-lg-4">
			<h4>Level: medium</h4>
			<img src="<c:url value="/resources/images/15-puzzle.png" />" alt="Responsive image" height="110">
		...
		<div class="col-lg-4">
			<h4>Level: hard</h4>
			<img src="<c:url value="/resources/images/24-puzzle.png" />" alt="Responsive image" height="110">
    ...
    <div class="col-md-5">
        <img src="<c:url value="/resources/images/gameDemo.gif" />" alt="Responsive image" height="300">
    </div>
</div>
